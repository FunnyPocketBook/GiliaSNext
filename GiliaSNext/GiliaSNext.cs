...
namespace GiliaSNext
{
    class GiliaSNext
    {
        ...
        private static HttpClient client = new HttpClient(httpHandler);
        ...
        static async Task<int> GetLoginLink()
        {
            ...
            try
            {
                ...
                iliasLoginUrl = new Uri("https://ilias.uni-konstanz.de/ilias/" + WebUtility.HtmlDecode(form.Attributes["action"].Value) + "&client_id=ilias_uni");
